    ...
    .then(() => {
      return Promise.all([
        ...
        knex('books').insert({
          ...
          //Alex Martelli
          author1_id: knex('authors').select('id').where('name', 'Alex Martelli'),
          // Anna Ravenscroft
          author2_id: knex('authors').select('id').where('name', 'Anna Ravenscroft'),
          // Steve Holden
          author3_id: knex('authors').select('id').where('name', 'Steve Holden')
        ...
        knex('books').insert({
          ...
          // Allen Downey
          author1_id: knex('authors').select('id').where('name', 'Allen Downey'),
          author2_id: null,
          author3_id: null
        }),
        knex('books').insert({
          ...
          author1_id: knex('authors').select('id').where('name', 'Bonnie Eisenman'),
          author2_id: null,
          author3_id: null
        }),
        knex('books').insert({
          ...
          //grabbing foreign key where first name and last name
          author1_id: knex('authors').select('id').where('name', 'Kyle Simpson'),
          author2_id: null,
          author3_id: null
        }),
        knex('books').insert({
